...
public class ArrayDequeTest {
    ...
    public void my_test_random_int() {
        ...
        ArrayDeque<Integer> que_first =new ArrayDeque<>();
        ArrayDeque<Integer> que_last =new ArrayDeque<>();
        //array中与que中添加N个随即元素
        for(int i=0;i<N;i++){
    ...
    public void my_test_random_double() {
        ...
        int first=0,last=N-1;
        ArrayDeque<Double> que_first =new ArrayDeque<>();
        ArrayDeque<Double> que_last =new ArrayDeque<>();
        //array中与que中添加N个随即元素
        for(int i=0;i<N;i++){
    ...
    @Test
    /* 使用两个ArrayDeque进行对照的操作，测试下面几个函数（随机的）
    addFirst,addLast
